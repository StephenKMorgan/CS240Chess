...
public class KingMoveTests {
    ...
    @Test
    public void kingMoveUntilEdge() throws InvalidMoveException {
        validateMoves("""
                        | | | | | | | | |
                        | | | | | | | | |
                        | | | | | | | | |
    ...
    @Test
    public void kingCaptureEnemy() throws InvalidMoveException {
        validateMoves("""
                        | | | | | | | | |
                        | | | | | | | | |
                        | | | | | | | | |
    ...
    @Test
    public void kingBlocked() throws InvalidMoveException {
        validateMoves("""
                        | | | | | | |r|k|
                        | | | | | | |p|p|
                        | | | | | | | | |
